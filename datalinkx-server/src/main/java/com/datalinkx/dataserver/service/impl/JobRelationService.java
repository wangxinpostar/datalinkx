...
public class JobRelationService {
    ...
    public PageVo<List<JobVo.JobRelationVo>> page(JobForm.JobLogPageForm jobLogPageForm) {
        ...
        PagedList<JobRelationBean> jobRelationBeans = jobRelationRepository.pageQuery(pageDomain, jobLogPageForm.getJobId());

        List<String> jobIds = new ArrayList<>();
        jobRelationBeans.forEach(jobRelationBean -> {
        ...
        List<JobVo.JobRelationVo> jobRelationVos = jobRelationBeans.stream().map(jobRelationBean -> JobVo.JobRelationVo.builder()
        ...
        result.setTotal(jobRelationBeans.getTotalSize());
    ...
    private void isCyclic(String jobId, String subJobId) {
        Map<String, List<String>> jobSubDepMap = jobRelationRepository.list().stream().collect(
